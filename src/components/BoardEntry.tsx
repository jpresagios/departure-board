...
import { getCarrier, getDestinationName, getTrainNumber, getTrainStatus, getTrainTime, getTrainTrackNumber } from "../utils/boardData";
...
function BoardEntry(props: { data: IPrediction }) {
  ...
  let trainNumber = getTrainNumber(data);
  ...
  return (
    <TableRow>
      <TableCell align="right">{getCarrier(data)}</TableCell>
